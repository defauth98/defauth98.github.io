...
var process = entry.commonjsGlobal.process;
...
if (!processOk(process)) {
  ...
  module.exports = function (cb, opts) {
    /* istanbul ignore if */
    if (!processOk(entry.commonjsGlobal.process)) {
      return;
    }
  ...
  var unload = function unload() {
    if (!loaded || !processOk(entry.commonjsGlobal.process)) {
      return;
    }
  ...
  var processEmit = function processEmit(ev, arg) {
    if (ev === 'exit' && processOk(entry.commonjsGlobal.process)) {
